...
subtitle: "Going from 20K to 1K lines of code"
...
You don't need to know much about `{ggstatsplot}` to follow these slides, except that it produces `ggplot2` plots with statistical analysis embedded in the plot. For more information, see these [slides](https://www.indrapatil.com/ggstatsplot_slides/slides/ggstatsplot_presentation.html#1). Here is an example plot:
...
- [`ggstatsplot`](https://www.indrapatil.com/ggstatsplot/): all things **graphics**
- [`statsExpressions`](https://www.indrapatil.com/statsExpressions/): all things **statistics**
...
[🔗 https://www.indrapatil.com/](https://www.indrapatil.com/)
