...
I am deliberately being terse here since these slides are about *how* I refactored the code, rather than *why* I did so.
...
Also have a look at `rlang::call2`: 
...
The following might be considered **bad coding practices** by some practitioners because they reduce readability of the code. I don't, so I've included them for the sake of completeness.
...
<iframe width="400" height="315" src="https://www.youtube.com/embed/7oyiPBjLAWY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<iframe width="400" height="315" src="https://www.youtube.com/embed/D4auWwMsEnY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
